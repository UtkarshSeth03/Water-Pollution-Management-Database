    ...
    useEffect(() => {
        const getDetails = async () => {
            try {
                ...
                let riverID = params.get("riverID")
                const response = await axios.get("http://localhost:8080/viewRiverDetails/" + riverID)
            ...
            {details.length === 0 ? (
                ...
                <div>
                    ...
                    <div style = {contentStyle}>
                        <div style = {bodyInfo}>
                            <h1 style = {riverHeadingStyle}>{details[0].river_name}</h1>
                            <p style = {informationStyle}>ID: {details[0].river_id}</p>
                            <p style = {informationStyle}>Level of Pollution: {details[0].level_of_pollution}</p>
                            <p style = {informationStyle}>Source: {details[0].source}</p>
                            <p style = {informationStyle}>Destination: {details[0].destination}</p>
                        </div>

                        <div>
                            <h2 style = {pollutantStyle}>The list of pollutants in this river:</h2>
                            <div>
...
export default ViewRiverDetails